...
func TestDownloadFormattedPDFSubmission(t *testing.T) {
	t.Run("happy - returns byte response", func(t *testing.T) {
		...
		res, err := client.DownloadFormattedPDFSubmission(formID, submissionID)
		assert.Nil(t, err)
	...
	t.Run("sad - permission denied", func(t *testing.T) {
		...
		_, err := client.DownloadFormattedPDFSubmission(formID, submissionID)
		assert.NotNil(t, err)
...
func TestDownloadSimplePDFSubmission(t *testing.T) {
	...
	t.Run("happy - returns byte response", func(t *testing.T) {
		...
		res, err := client.DownloadSimplePDFSubmission(formID, submissionID)
		assert.Nil(t, err)
	...
	t.Run("sad - permission denied", func(t *testing.T) {
		...
		_, err := client.DownloadSimplePDFSubmission(formID, submissionID)
		assert.NotNil(t, err)
		assert.Contains(t, err.Error(), "401")
	})
}
